...
public class Child extends BaseObservable implements Observable {
    ...
    private String im0502ad = "0";
    private String im0502am = _EMPTY_;
    private String im0502ay = _EMPTY_;
    ...
    private String im0515ad = "0";
    private String im0515am = _EMPTY_;
    private String im0515ay = _EMPTY_;
    private String im0515bd = "0";
    private String im0515bm = _EMPTY_;
    private String im0515by = _EMPTY_;
    ...
    public void setIm01(String im01) {
        ...
        setIm0502ad(im01.equals("1") ? this.im0502ad : "0");
        setIm0502am(im01.equals("1") ? this.im0502am : "");
        setIm0502ay(im01.equals("1") ? this.im0502ay : "");
    ...
    public void setIm02(String im02) {
        ...
        setIm0502ad(im02.equals("1") ? this.im0502ad : "0");
        setIm0502am(im02.equals("1") ? this.im0502am : "");
        setIm0502ay(im02.equals("1") ? this.im0502ay : "");
    ...
    public void setIm0502ad(String im0502ad) {
        ...
        boolean b = im0502ad.length() > 0 && Integer.parseInt(im0502ad) > 31;
        setIm0502am(b ? "" : this.im0502am);
        setIm0502ay(b ? "" : this.im0502ay);
    ...
    public void setIm0515ad(String im0515ad) {
        ...
        boolean b = im0515ad.length() > 0 && Integer.parseInt(im0515ad) > 31;
        setIm0515am(b ? "" : this.im0515am);
        setIm0515ay(b ? "" : this.im0515ay);
    ...
    public void setIm0515bd(String im0515bd) {
        ...
        boolean b = im0515bd.length() > 0 && Integer.parseInt(im0515bd) > 31;
        setIm0515bm(b ? "" : this.im0515bm);
        setIm0515by(b ? "" : this.im0515by);
    ...
    public void setIm08(String im08) {
        ...
        setIm2601(im08.equals("2") || im08.equals("98") ? this.im2601 : "");
        setIm2602(im08.equals("2") || im08.equals("98") ? this.im2602 : "");
        setIm2603(im08.equals("2") || im08.equals("98") ? this.im2603 : "");
        setIm2604(im08.equals("2") || im08.equals("98") ? this.im2604 : "");
        setIm2605(im08.equals("2") || im08.equals("98") ? this.im2605 : "");
        setIm2606(im08.equals("2") || im08.equals("98") ? this.im2606 : "");
        setIm2607(im08.equals("2") || im08.equals("98") ? this.im2607 : "");
        setIm2608(im08.equals("2") || im08.equals("98") ? this.im2608 : "");
        setIm2609(im08.equals("2") || im08.equals("98") ? this.im2609 : "");
        setIm2610(im08.equals("2") || im08.equals("98") ? this.im2610 : "");
        setIm2611(im08.equals("2") || im08.equals("98") ? this.im2611 : "");
        setIm2612(im08.equals("2") || im08.equals("98") ? this.im2612 : "");
        setIm2613(im08.equals("2") || im08.equals("98") ? this.im2613 : "");
        setIm2614(im08.equals("2") || im08.equals("98") ? this.im2614 : "");
        setIm2615(im08.equals("2") || im08.equals("98") ? this.im2615 : "");
        setIm2616(im08.equals("2") || im08.equals("98") ? this.im2616 : "");
        setIm2617(im08.equals("2") || im08.equals("98") ? this.im2617 : "");
        setIm2696(im08.equals("2") || im08.equals("98") ? this.im2696 : "");
        setIm2698(im08.equals("2") || im08.equals("98") ? this.im2698 : "");
    ...
    public void setIm12(String im12) {
        this.im12 = im12;
        setIm1201x(im12.equals("1") ? this.im1201x : "");
    ...
    public Child Hydrate(Cursor cursor) throws JSONException {
        ...
        this.name = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChildTable.COLUMN_NAME));
    ...
    public void sIMHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            ...
            this.im0502ad = json.getString("im0502ad");
            this.im0502am = json.getString("im0502am");
            this.im0502ay = json.getString("im0502ay");
            ...
            this.im0515ad = json.has("im0515ad") ? json.getString("im0515ad") : "";
            this.im0515am = json.has("im0515am") ? json.getString("im0515am") : "";
            this.im0515ay = json.has("im0515ay") ? json.getString("im0515ay") : "";
            this.im0515bd = json.has("im0515bd") ? json.getString("im0515bd") : "";
            this.im0515bm = json.has("im0515bm") ? json.getString("im0515bm") : "";
            this.im0515by = json.has("im0515by") ? json.getString("im0515by") : "";
            ...
            this.im22a = json.has("im22a") ? json.getString("im22a") : "";
    ...
    public String sIMtoString() throws JSONException {
        ...
        json.put("im01", im01)
                ...
                .put("im0502m", im0502m)
                .put("im0502y", im0502y)
                .put("im0502ad", im0502ad)
                .put("im0502am", im0502am)
                .put("im0502ay", im0502ay)
                .put("im0503d", im0503d)
                .put("im0503m", im0503m)
                .put("im0503y", im0503y)
                .put("im0504d", im0504d)
                ...
                .put("im0515m", im0515m)
                .put("im0515y", im0515y)
                .put("im0515ad", im0515ad)
                .put("im0515am", im0515am)
                .put("im0515ay", im0515ay)
                .put("im0515bd", im0515bd)
                .put("im0515bm", im0515bm)
                .put("im0515by", im0515by)
                .put("im0516d", im0516d)
                .put("im0516m", im0516m)
                .put("im0516y", im0516y)
                .put("im07", im07)
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(TableContracts.ChildTable.COLUMN_NAME, this.name);
