...
import edu.aku.imranahmed.vasa2022.databinding.ActivitySectionAh7Binding;
import edu.aku.imranahmed.vasa2022.ui.EndingActivity;


public class SectionAH7Activity extends AppCompatActivity {

    private static final String TAG = "SectionAH7Activity";
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesAdolColumn(TableContracts.AdolescentTable.COLUMN_SAH7, adol.sAH7toString());
