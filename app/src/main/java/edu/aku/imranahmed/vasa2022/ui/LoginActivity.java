...
import static edu.aku.imranahmed.vasa2022.core.CipherSecure.decryptGCM;
import static edu.aku.imranahmed.vasa2022.core.CipherSecure.encryptGCM;
import static edu.aku.imranahmed.vasa2022.core.CipherSecure.hashSHA256;
import static edu.aku.imranahmed.vasa2022.core.MainApp.PROJECT_NAME;
import static edu.aku.imranahmed.vasa2022.core.MainApp.sharedPref;
import static edu.aku.imranahmed.vasa2022.database.DatabaseHelper.DATABASE_COPY;
import static edu.aku.imranahmed.vasa2022.database.DatabaseHelper.DATABASE_NAME;
   ...
   /* private int PhotoSerial = 0;
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.imranahmed.vasa2022.ui.SyncActivity.class).putExtra("login", true));
        } else {
