...
import edu.aku.imranahmed.vasa2022.databinding.ActivitySectionUnBinding;
import edu.aku.imranahmed.vasa2022.ui.EndingActivity;

public class SectionUNActivity extends AppCompatActivity {

    private static final String TAG = "SectionUNActivity";
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesMWRAColumn(TableContracts.MwraTable.COLUMN_UN, MainApp.mwra.uNtoString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            startActivity(new Intent(this, SectionLActivity.class).putExtra("complete", true));
        } else {
