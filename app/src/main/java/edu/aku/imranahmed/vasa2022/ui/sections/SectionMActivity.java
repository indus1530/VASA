...
import edu.aku.imranahmed.vasa2022.databinding.ActivitySectionMBinding;
...
public class SectionMActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesFormColumn(TableContracts.FormsTable.COLUMN_SM, MainApp.form.sMtoString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            startActivity(new Intent(this, NeonateAActivity.class).putExtra("complete", true));
        } else {
