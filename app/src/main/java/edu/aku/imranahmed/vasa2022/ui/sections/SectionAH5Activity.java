...
import edu.aku.imranahmed.vasa2022.databinding.ActivitySectionAh5Binding;
...
public class SectionAH5Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesAdolColumn(TableContracts.AdolescentTable.COLUMN_SAH5, adol.sAH5toString());
